...
for i in range(2,10):
    source = requests.get("https://www.amazon.in/s?rh=n%3A976389031%2Cn%3A%21976390031%2Cn%3A15417300031%2Cn%3A4149418031%2Cn%3A4149470031&page="+str(i)+"&qid=1566657825&ref=lp_4149470031_pg_"+str(i)).text
